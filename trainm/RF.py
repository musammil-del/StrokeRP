"""
Random Forest Classifier - Train/Test Split (70/30) + GridSearchCV (10-fold CV)
================================================================================
- โหลดข้อมูลจาก Book1.xlsx
- แบ่งข้อมูล Train 70% / Test 30%
- ใช้ GridSearchCV (cv=10) เพื่อหาโมเดล Random Forest ที่ดีที่สุด
...
TARGET_COL = "Stroke_Type"        # คอลัมน์เป้าหมาย (label)
          ...
          # คอลัมน์ ID ที่ไม่ใช้เป็น feature
